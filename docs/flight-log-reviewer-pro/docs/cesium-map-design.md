...
Show the actual drone route over a professional 3D globe/map so reviewers can
see where the aircraft flew, how altitude changed, which mode it was in, and
